const { getConnection, setCachedMessageReactions, getCachedMessageReactions } = require('../../backend/functions')

module.exports = async (Discord, client, reaction, user) => {
    const addMemberRole = (results) => {
    ...
    if (reaction.message.partial) {
        ...
        let results = getCachedMessageReactions(reaction.message.id);
